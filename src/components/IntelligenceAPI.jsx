...
const responseLines = [
  ...
  '      "quarter_change": "+4.2%",',
  '      "insight": "Martell multi-year AfroFuture partnership and exclusive VIP activation at December festival driving top-quartile affinity."',
  '    },',
  '    {',
  '      "brand": "Hennessy",',
  '      "affinity_score": 61,',
  ...
  '      "trend_direction": "stable",',
  '      "quarter_change": "-0.3%",',
  '      "insight": "Jack Daniels operates as category default with minimal cultural differentiation."',
  '    }',
  '  ],',
  '  "category_aggregate": {',
  '    "average_affinity": 54,',
  ...
  '    "spend_shift_indicator": "Share of wallet moving from standard (Jack Daniels) to premium (Martell, Hennessy)"',
  '  },',
    ...
    <section style={{ padding: '100px 40px', maxWidth: '1400px', margin: '0 auto' }} id="intelligence-api">
      <div style={{ textAlign: 'center', marginBottom: '64px' }}>
        ...
        <p style={{ fontSize: '18px', color: '#8a8a9a', maxWidth: '640px', margin: '0 auto', lineHeight: 1.6 }}>
          ...
          first-party live event data into actionable intelligence for brands and investors.
        </p>
      </div>
      ...
      <div className="animate-fade-in-up" style={{
        ...
        <div style={{ padding: '32px', overflowX: 'auto' }}>
          ...
          <div style={{ background: '#0a0a0f', border: '1px solid #2a2a35', borderRadius: '12px', overflow: 'hidden', marginBottom: '24px' }}>
            ...
            <div style={{ padding: '20px', fontFamily: 'var(--font-mono)', fontSize: '13px', lineHeight: 1.7, color: '#8a8a9a' }}>
              <div><span style={{ color: '#3498db' }}>GET</span> <span style={{ color: '#2ecc71' }}>/v1/sentiment?market=accra&amp;category=spirits&amp;time_window=90d</span></div>
              <div><span style={{ color: '#5a5a6a', fontStyle: 'italic' }}>Authorization: Bearer {'{'}enterprise_token{'}'}</span></div>
              <div><span style={{ color: '#5a5a6a', fontStyle: 'italic' }}>Content-Type: application/json</span></div>
            </div>
          </div>
